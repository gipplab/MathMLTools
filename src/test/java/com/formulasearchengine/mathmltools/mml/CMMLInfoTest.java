...
public class CMMLInfoTest {
  private static final String MML_TEST_DIR = "";
  ...
  public final void testStrictCmml1() throws Exception {
    String simpleMathTag = getFileContents(MML_TEST_DIR + "com/formulasearchengine/mathmltools/mml/sample.mml");
    String simpleStrictMathTag = getFileContents(MML_TEST_DIR + "com/formulasearchengine/mathmltools/mml/reference_sample.mml");
...
//    final String sampleMML = TestUtils.getFileContents(MML_TEST_DIR + "Emc2.xml");
...
//    final String sampleMML = TestUtils.getFileContents(MML_TEST_DIR + "testquery1.xml");
//    CMMLInfo cmml = new CMMLInfo(sampleMML);
...
//  }
  ...
  public final void testStrictQueryTest() throws Exception {
    final String sampleMML = getFileContents(MML_TEST_DIR + "com/formulasearchengine/mathmltools/mml/query1.xml");
...
//        "</result>";
//    final String sampleMML = TestUtils.getFileContents(MML_TEST_DIR + "query1.xml");
//    CMMLInfo mml = new CMMLInfo(sampleMML);
